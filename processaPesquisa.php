...
/*if(mysqli_num_rows($result)==0){
    ...
    if (mysqli_num_rows($result)) {
        ...
        // atualiza as abertas
        $sql = "INSERT INTO pesquisa (idResultado, usabilidade, tutoriais, geral, dataResposta) VALUES (".$resultados["idResultado"].",'" .utf8_decode($_POST["usabilidade"])."','" .utf8_decode($_POST["tutoriais"])."','".utf8_decode($_POST["geral"])."', now())";
        require "executaQuery.php";
