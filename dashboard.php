...
-->                <div class="card d-flex flex-row canvaBoy">
                ...
                <div class="card d-flex flex-row canvaGirl">
                    <div class="card-body" style="background:url(img/Instrucoes/guias/chat_bubble_right.png) no-repeat; background-size:100% 100%;">
                        ...
                        <p class="card-text pr-5">Para iniciar seu teste, você precisa selecionar aqui na caixinha a sua chave de acesso! É só selecionar seu curso / série. Vamos lá? Para mais orientações, clica <a href="CT_Puzzle_Test_Guia_Instrucoes.pdf" target="_blank">aqui</a> e veja nosso <a href="CT_Puzzle_Test_Guia_Instrucoes.pdf" target="_blank">guia de instruções</a>!</p>
