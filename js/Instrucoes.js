...
Instrucoes.prototype.MouseUp = function(mouseEvent) {
	if(this.indice==1 || this.indice==4 || this.indice==6 || this.indice==8 || this.indice==9 || this.indice==11 || this.indice==12 || this.indice==13 || this.indice==14 || this.indice==15 || this.indice==16)this.ativo=false;
