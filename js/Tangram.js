var Tangram = function (fase) {
	...
	this.fase=fase;
	if(this.fase==1)this.fundo=tdsImagens[189];
	else if(this.fase==2)this.fundo=tdsImagens[190];
	this.ativo=true;
	this.pulou=false;
	...
	if(this.fase==1){
		...
		for(this.i=0;this.i<3;this.i++){
			...
			this.figs.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.figs[this.figs.length-1].img=tdsImagens[191+this.i];
			this.dicaImagem.push(new Imagem(20,70, 179, 179,""));
			this.dicaImagem[this.dicaImagem.length-1].img=tdsImagens[194+this.i];
			this.dicaPos.push(new Imagem(20,70, 179, 179,""));
			this.dicaPos[this.dicaPos.length-1].img=tdsImagens[194+this.i];
			this.newPosRot0.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot0[this.newPosRot0.length-1].img=tdsImagens[191+this.i];
			this.newPosRot1.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot1[this.newPosRot1.length-1].img=tdsImagens[191+this.i];
			this.newPosRot2.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot2[this.newPosRot2.length-1].img=tdsImagens[191+this.i];
			this.newPosRot3.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot3[this.newPosRot3.length-1].img=tdsImagens[191+this.i];
			this.newPosRot4.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot4[this.newPosRot4.length-1].img=tdsImagens[191+this.i];
			this.newPosRot5.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot5[this.newPosRot5.length-1].img=tdsImagens[191+this.i];
			this.newPosRot6.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot6[this.newPosRot6.length-1].img=tdsImagens[191+this.i];
			this.newPosRot7.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot7[this.newPosRot7.length-1].img=tdsImagens[191+this.i];
		...
		//ESSAS AQUI NA VERDADE SÃO A POS DAS RESPOSTAS----------------------------------------------
		...
		//ESSAS AQUI QUE SÃO AS POS DAS DICAS VERDADEIRAS PQ RESOLVI NÃO GIRAR ELAS NAQUELA MALUQUICE
		this.dicaPos[0].x=413;this.dicaPos[0].y=115;
		this.dicaPos[1].x=497;this.dicaPos[1].y=282;
		this.dicaPos[2].x=499;this.dicaPos[2].y=280;
		for(this.i=0;this.i<3;this.i++){
		...
		for(this.i=0;this.i<4;this.i++){
			this.tipoFigs.push(this.i);
			this.figs.push(new Imagem(0,0, 179, 179,""));
			this.figs[this.figs.length-1].img=tdsImagens[197+this.i];
			this.dicaImagem.push(new Imagem(20,70, 179, 179,""));
			this.dicaImagem[this.dicaImagem.length-1].img=tdsImagens[201+this.i];
			this.newPosRot0.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot0[this.newPosRot0.length-1].img=tdsImagens[197+this.i];
			this.newPosRot1.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot1[this.newPosRot1.length-1].img=tdsImagens[197+this.i];
			this.newPosRot2.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot2[this.newPosRot2.length-1].img=tdsImagens[197+this.i];
			this.newPosRot3.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot3[this.newPosRot3.length-1].img=tdsImagens[197+this.i];
			this.newPosRot4.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot4[this.newPosRot4.length-1].img=tdsImagens[197+this.i];
			this.newPosRot5.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot5[this.newPosRot5.length-1].img=tdsImagens[197+this.i];
			this.newPosRot6.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot6[this.newPosRot6.length-1].img=tdsImagens[197+this.i];
			this.newPosRot7.push(new Imagem(20,70+(150*this.i), 179, 179,""));
			this.newPosRot7[this.newPosRot7.length-1].img=tdsImagens[197+this.i];
			this.dicaPos.push(new Imagem(20,70, 179, 179,""));
		...
		//ESSAS AQUI QUE SÃO AS POS DAS DICAS VERDADEIRAS PQ RESOLVI NÃO GIRAR ELAS NAQUELA MALUQUICE
		this.dicaPos[0].x=413;this.dicaPos[0].y=208;
		this.dicaPos[1].x=413;this.dicaPos[1].y=140;
		this.dicaPos[2].x=477;this.dicaPos[2].y=207;
		this.dicaPos[3].x=413;this.dicaPos[3].y=306;
		for(this.i=0;this.i<4;this.i++){
			this.dicaImagem[this.i].width=this.figs[this.i].width;
			this.dicaImagem[this.i].height=this.figs[this.i].height;
		}
...
Tangram.prototype.Draw = function(){
	...
	if(this.dicaAtual!=-1){
		context.drawImage(this.dicaImagem[this.dicaAtual].img,this.dicaPos[this.dicaAtual].x,this.dicaPos[this.dicaAtual].y);
	}
